...
## Using crictl (Recommended for Kubernetes in containerd)

## First, install crictl (if not installed):

```bash
sudo apt install -y cri-tools

```
## Second, list containers:
...
## To kill a container using crictl, use the following command:

```bash
sudo crictl stop <container-id>

```
## If you want to completely remove the container after stopping it, use:
